...
public class MyFeedRecyclerViewAdapter extends RecyclerView.Adapter<MyFeedRecyclerViewAdapter.ViewHolder>  {
    ...
    public MyFeedRecyclerViewAdapter(List<Feed> items, FeedFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(holder.mItem.links.get(0).type == 2) {
            ...
            if(holder.mItem.links.get(0).text.isEmpty()) {
                mListener.onListFragmentInteraction(1,position, holder.mItem);
            }else{
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                  mListener.onListFragmentInteraction(0,position,holder.mItem);
                }
            }
        });
